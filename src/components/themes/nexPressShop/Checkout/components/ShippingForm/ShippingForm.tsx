          ...
          <div>
            ...
            <div className="relative mt-2 rounded-md shadow-sm">
              <input
                ...
                {...getFieldProps('shipping.firstName')}
              />
            </div>
          </div>
          ...
          <div>
            ...
            <div className="relative mt-2 rounded-md shadow-sm">
              <input
                ...
                required
                className="py-1.5 pl-7 pr-20 ring-1 ring-inset ring-gray-300 w-full"
                {...getFieldProps('shipping.lastName')}
              />
            </div>
          </div>
        </div>
        ...
        <div>
          ...
          <div className="relative mt-2 rounded-md shadow-sm">
            <input
              ...
              id="company"
              className="py-1.5 pl-7 pr-20 ring-1 ring-inset ring-gray-300 w-full"
              {...getFieldProps('shipping.company')}
            />
          </div>
        </div>
        ...
        <div>
          ...
          <div className="relative mt-2 rounded-md shadow-sm">
            <input
              ...
              required
              className="py-1.5 pl-7 pr-20 ring-1 ring-inset ring-gray-300 w-full"
              {...getFieldProps('shipping.address1')}
            />
          </div>
        </div>
        ...
        <div>
          ...
          <div className="relative mt-2 rounded-md shadow-sm">
            <input
              ...
              id="address2"
              className="py-1.5 pl-7 pr-20 ring-1 ring-inset ring-gray-300 w-full"
              {...getFieldProps('shipping.address2')}
            />
          </div>
        </div>
        ...
        <div>
          ...
          <div className="relative mt-2 rounded-md shadow-sm">
            <input
              ...
              required
              className="py-1.5 pl-7 pr-20 ring-1 ring-inset ring-gray-300 w-full"
              {...getFieldProps('shipping.postcode')}
            />
          </div>
        </div>
